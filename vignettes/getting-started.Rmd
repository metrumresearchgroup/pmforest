...
![](../assets/forest/forest-data-ex.png)<!-- -->
...
![](../assets/forest/forestPlot-baseCase.png)<!-- -->
...
![](../assets/forest/forestPlot-labels.png)<!-- -->

<br>

### Multiple covariates (or facets)
The `metagroup` argument doesn't necessarily have to facet across multiple covariates. Regardless, you can specify how you want to align the plots using the `nrow` argument or other functions in the `patchwork` R package. You may consider setting `annotate_CI = FALSE` to simplify the plots.
...
:-------------------------:|:-------------------------:
![](../assets/forest/forestPlot-multiple1.png)  |  ![](../assets/forest/forestPlot-multiple2.png)
...
![](../assets/forest/forestPlot-metagroup.png) 
...
![](../assets/forest/forestPlot-annotations.png)<!-- -->
...
:-------------------------:|:-------------------------:
![](../assets/forest/forestPlot-shadedInterval1.png)  |  ![](../assets/forest/forestPlot-shadedInterval2.png)
...
![](../assets/forest/forest-plot-ex.png)<!-- -->
